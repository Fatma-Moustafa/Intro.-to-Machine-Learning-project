...
data <- read.csv("G:/ML/project/modification 1/finalCSV.csv")
...
F0
tunedparam <- tune.svm(x= train_set[, 2:9], y= train_set[, 1] , type = "C-classification", kernel="radial", cost= 10^(-4:4), gamma = c(0.1,1,10), coef0 = c(0.1,1,10))
tunedparam$best.parameters$cost
tunedparam$best.parameters$gamma
tunedparam$best.parameters$coef0
